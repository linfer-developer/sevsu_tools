...
class Lesson(Base):
    ...
    __dependencies__: tuple = ("week", "group")
    ...
    __table_args__: tuple = (
        UniqueConstraint(*__unique_keys__, name="uix_lesson_unique"),
    )


class Week(Base):
    __tablename__ = "week"
    __unique_keys__: tuple = ("title", "start_date", "end_date")
    __dependencies__: tuple = None
    ...
    __table_args__: tuple = (
        UniqueConstraint(*__unique_keys__, name="uix_week_unique"),
    )


class Group(Base):
    __tablename__: str = "group"
    __unique_keys__: tuple = ("name",)
    __dependencies__: tuple = None
    ...
    __table_args__: tuple = (
        UniqueConstraint(*__unique_keys__, name="uix_group_unique"),
    )
